...
def create_project_prompt(packages: List[str], content: str, unavailable: List[str] = None) -> str:
    ...
    if packages:
        ...
        available = [pkg for pkg in packages if not unavailable or pkg not in unavailable]
        if available:
